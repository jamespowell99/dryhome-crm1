 ...
 */
public class ManualInvoiceDetailDTO implements Serializable {
    ...
    public List<ManualInvoiceItemDTO> getItems() {
        return items;
    }

    public void setItems(List<ManualInvoiceItemDTO> items) {
        this.items = items;
    }
    ...
    public boolean equals(Object o) {
        ...
        ManualInvoiceDetailDTO manualInvoiceDTO = (ManualInvoiceDetailDTO) o;
