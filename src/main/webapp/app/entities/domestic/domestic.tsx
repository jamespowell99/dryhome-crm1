...
export class Customer extends React.Component<ICustomerProps, ICustomerState> {
  ...
  search = () => {
    if (this.state.search) {
      this.setState({ activePage: 1 }, () => {
        ...
        this.props.getSearchEntities(search + ' AND type:DOMESTIC', activePage - 1, itemsPerPage, `${sort},${order}`);
      });
    }
  };
  ...
  getEntities = () => {
    ...
    if (search) {
      ...
      this.props.getSearchEntities('type:DOMESTIC', activePage - 1, itemsPerPage, `${sort},${order}`);
    }
  };
