...
import { getEntity, deleteEntity } from 'app/entities/domestic/domestic.reducer';
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="dryhomecrm1App.customer.delete.question">Are you sure you want to delete this Domestic?</ModalBody>
        <ModalFooter>
